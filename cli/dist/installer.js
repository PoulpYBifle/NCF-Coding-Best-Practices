...
async function copyFile(templatesDir, targetDir, src, dest) {
...
export async function install(choices) {
    ...
    if (choices.includeConstitution) {
        const copied = await copyFile(templatesDir, targetDir, "docs/CLEAN-CODE-CONSTITUTION-V5.md", ".ncf/docs/CLEAN-CODE-CONSTITUTION-V5.md");
        if (copied) {
